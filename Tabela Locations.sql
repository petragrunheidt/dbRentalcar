...
-- Adicionando dados na tabela LOCATIONS
...
-- Exibe join table de locações com nome de cliente, automovel e funcionário
...
SELECT 
  ...
  LOCATIONS.END_DATE,
  LOCATIONS.TOTAL,
  CUSTOMERS.NAME || ' ' || CUSTOMERS.LASTNAME AS 'Nome do Cliente',
